...
\section{Hypergeometric Form for Real Arguments}

\textbf{Restriction to Real Domain.} The hypergeometric representation of the truncation remainder derived in Lemma~4.2.3.1:
\[
...
\paragraph{Proof of restriction.} In the derivation, we used:
\[
...
\section{Shannon Wavelet Derivations}
...
\subsubsection{Synthesis Quality Metrics}
